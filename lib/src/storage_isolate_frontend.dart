...
/// Flutter StorageIsolateFrontend
/// 
/// Storage isolate frontend for commit log based database.
/// 
class StorageIsolateFrontend extends IsolateController {
  final String path;
  final HashMap<String, Completer> _pendingCompleters;
  final HashMap<String, Sink> _pendingSinks;

  StorageIsolateFrontend._init(this.path)
  ...
  /// be contained in.
  /// 
  static Future<StorageIsolateFrontend> open(String path) async {
    var ctrl = StorageIsolateFrontend._init(path);
  ...
  /// 
  Future<StorageIsolateFrontend> closeAndOpen(String newPath) async {
